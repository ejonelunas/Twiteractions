...
async function main() {
    ...
    const user = await getUser("EJonelunas");

    const layers = [9, 16, 27];
    ...
    await render([
        ...
        {distance: 0, count: layers[1], radius: 58, users: data[1]},
        {distance: 0, count: layers[2], radius: 50, users: data[2]},
    ]);
